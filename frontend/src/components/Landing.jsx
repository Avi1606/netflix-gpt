      ...
      <div className="relative overflow-hidden">
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                  ...
                  <span className="block text-blue-600 xl:inline">Job Interview</span>
                </h1>
                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Practice job interviews with our AI-powered simulator. Get real-time feedback on your answers, 
                  body language, and speech patterns. Build confidence and land your dream job.
                </p>
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <div className="h-56 w-full bg-gray-300 sm:h-72 md:h-96 lg:w-full lg:h-full flex items-center justify-center">
            <div className="text-gray-500 text-lg">Interview Simulation Demo</div>
          </div>
        </div>
      </div>
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              ...
              <div className="relative">
                ...
                <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Real-time Analysis</p>
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Get instant feedback on your speech patterns, confidence level, and body language.
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <p className="mt-2 ml-16 text-base text-gray-500">
                  Receive detailed recommendations and tips to improve your interview performance.
                </p>
              </div>
            </div>
          </div>
